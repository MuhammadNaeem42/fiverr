...
<div class="nav-header">
    <a href="index.html" class="brand-logo">
        <img src="{{asset(setting('logo'))}}" alt="" width="52px">
        <span class="h3 pe-3 ahmed">{{setting('application_name')}}</span>
    </a>
        ...
        <nav class="navbar navbar-expand">
            <div class="collapse navbar-collapse justify-content-between">
                ...
                <ul class="navbar-nav header-right main-notification">
                    ...
                    <li hidden class="nav-item dropdown notification_dropdown notification-bell">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <div id="dlab_W_Notification1" class="widget-media dz-scroll p-3 height380">
                                <ul class="timeline myScrollNotification">
                                    @foreach(auth('admin')->user()->notifications()->orderBy('created_at', 'desc')->limit(5)->get() as $notification)
                                        <li>
                                            <a href="{!! isset($notification->data['id'])?route('admin.contracts.show',Illuminate\Support\Facades\Crypt::encrypt($notification->data['id']) ):'#'!!}">
                                            <div class="timeline-panel">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <small
                                                        class="d-block">{{Carbon\Carbon::createFromDate($notification->created_at)->format('Y-m-d H:i')}}</small>
                                                </div>
                                            </div>
                                            </a>
                                        </li>
                            ...
                            <a class="all-notification"
                               href="{{route('admin.notifications.index')}}">{{trans('notifications.See all notifications')}} <i
                    ...
                    <li class="nav-item dropdown header-profile px-3">
                        <a class="nav-link" href="#" role="button" data-bs-toggle="dropdown">
                            <img src="{{ auth('admin')->user()->photo }}" width="20" alt=""/>
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a href="{{ route('admin.profile.detail') }}" class="dropdown-item ai-icon">
                                ...
                                <span class="ms-2">{{trans('lang.profile')}} </span>
                            </a>
                            <a class="dropdown-item ai-icon" href="javascript:void(0);"
                               onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                ...
                                <span class="ms-2">{{trans('lang.logout')}} </span>
                            </a>
                    ...
                    <li class="nav-item dropdown header-profile px-3">
                        <a class="av-link ai-icon" href="javascript:void(0);"
                           onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                            <svg id="icon-logout" xmlns="http://www.w3.org/2000/svg" class="text-danger"
                                 width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                 stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
